 ...
 * <p>
 * Below is a sample of the XML model that serves as the inline content for the Atom
 * entry. All attributes follow this basic name value pattern. One or more values may 
 * be nested within certain attribute nodes. 
 * </p>
 * &lt;session-attributes&gt;
 *   &lt;roles&gt;
 *     &lt;role id="Name of Group,ou=group,dc=apius,dc=org"&gt;
 *   &lt;/roles&gt;
 *   &lt;attributes&gt;
...
public final class SessionAttributesImpl extends ServerResource implements SessionAttributes {
    ...
    private Representation getAttributesRepresentation(String token) {
    	...
    	try {
    	    representation = sessionProvisionerProxy.getSessionAttributes(getChallengeResponse().getRawValue());
