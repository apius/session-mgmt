 ...
 * </p>
 * <p>
 * The session provisioner proxy object implementing the <code>Session</code> 
 * interface is the session provisioner mediator. Hiding the implementation 
 * behind this common interface allows us to 1) design a consistent RESTful 
 * interface for managing sessions across our API and 2) keep the public contract 
 * consistent even if more than one stateful session provisioner (more than one 
...
public interface Session {
     ...
     * entity body or encoded as an HTTP Basic Authentication string.
     * 
